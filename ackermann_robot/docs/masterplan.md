...
> **Current goal authority (2026-07-12):**
> [`universal-adaptive-ackermann.md`](universal-adaptive-ackermann.md) defines
> the target universal learning node, current baseline, portability contract,
> and migration/proof plan. This masterplan remains historical context and a
> record of earlier research decisions. Where its target architecture conflicts
> with the universal-learning document, the newer document is authoritative.
